...
def create_supervisor_prompt():
    ...
    system_prompt = (
        ...
        "\n"
        "RULE — Delegation: Once update_state has completed and returned, call search_flights and search_hotels\n"
        "together in the same response — do not wait for one to finish before calling the other.\n"
        "Call each at most once per delegation, even if you want to double-check or refine the results.\n"
        "Once you have received both the flight and hotel results, output the full response using the format below.\n"
        "\n"
    ...
    response_prompt = (
        ...
        "[1-2 warm sentences summarising the trip. Mention origin, destination, the travel season or dates, "
        "number of adults, and currency. "
